...
> **Статус:** историческая контрольная точка. Срез проекта, устойчивость к
> пустым `site_settings` и порядок развёртывания живого сайта с CMS закрыты
> документом `docs/Desire_House_CMS_ARCHITECTURE_CHECKPOINT_4.md`
> (v4.0, 12 сентября 2026).
