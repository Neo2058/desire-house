...
✔ Страница услуги `/uslugi/{slug}`

✔ Каталог работ `/raboty`

✔ Страница проекта `/raboty/{slug}`
...
✔ Главная не падает без записи настроек сайта

✔ Порядок первого запуска и обновления живого сервера с CMS

---

# Следующий этап

На проде — свободные страницы «О компании» и «Контакты», меню и настройки сайта.
По коду — уведомления по заявкам.

Контрольная точка среза: `docs/Desire_House_CMS_ARCHITECTURE_CHECKPOINT_4.md`

Развёртывание и обновление продакшена: `docs/DEPLOYMENT_GUIDE.md`.
